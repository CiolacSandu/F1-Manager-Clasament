namespace F1Manager.Formulare
{
    partial class DashboardUserForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            labelHeader.Size = new Size(362, 50);
            labelHeader.TabIndex = 0;
            labelHeader.Text = "Dashboard Utilizator";
            ...
            labelSubHeader.Size = new Size(520, 23);
            labelSubHeader.TabIndex = 1;
            labelSubHeader.Text = "Vizualizează piloții, echipele, cursele și clasamentele sezonului.";
            ...
            Text = "F1 Manager - Dashboard Utilizator";
            Load += new EventHandler(DashboardUserForm_Load);
