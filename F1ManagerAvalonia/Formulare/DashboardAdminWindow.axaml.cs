...
namespace F1ManagerAvalonia.Formulare
{
    public partial class DashboardAdminWindow : Window
    {
        ...
        public DashboardAdminWindow()
        {
            ...
            btnAdaugaPilot.Click += (s, e) => ShowMessage("Navigare către Piloti");
            ...
            btnVeziRezultateComplet.Click += (s, e) => ShowMessage("Navigare către Rezultate");
        ...
        private async void BtnBackup_Click(object? sender, RoutedEventArgs e)
        {
            ...
            await MessageBoxHelper.ShowInfo("Backup realizat cu succes!", "Succes");
        }
    }
}